        ...
        <div className="drawer lg:drawer-open">
            ...
            <div className="drawer-content">
                ...
                <nav className="navbar w-full bg-base-300">
                    ...
                    <div className="px-4"><Link to="/" className="btn btn-ghost font-bold text-2xl bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent text-center lg:text-start">ThreadOps</Link></div>
                </nav>
                {/* Page content here */}
                <Outlet></Outlet>
            </div>
