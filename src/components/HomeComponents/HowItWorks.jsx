  ...
  return (
    <div className="py-16 px-10 bg-gray-50">
      <div className="text-center mb-12">
        <h1 className="text-4xl text-center font-bold mb-10">How ThreadOps Works</h1>
        <p className="text-lg text-gray-500 mt-4">A simple 4-step process to streamline your garment management needs</p>
      </div>
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
        ...
        <div className="card w-full bg-white shadow-lg rounded-lg p-6">
          <div className="card-body text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-800">Sign Up & Login</h3>
        ...
        <div className="card w-full bg-white shadow-lg rounded-lg p-6">
          <div className="card-body text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-800">Upload Garment Details</h3>
        ...
        <div className="card w-full bg-white shadow-lg rounded-lg p-6">
          <div className="card-body text-center">
            ...
            <h3 className="text-xl font-semibold text-gray-800">Track & Analyze</h3>
